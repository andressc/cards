    ...
    <IconWrapper
      icon={
        <svg
          ...
          {...props}
        >
          <g clipPath={'url(#clip0_5661_1880)'}>
            <path
              d={
            ...
            <path
              d={
                'M8 10C8.82843 10 9.5 9.32843 9.5 8.5C9.5 7.67157 8.82843 7 8 7C7.17157 7 6.5 7.67157 6.5 8.5C6.5 9.32843 7.17157 10 8 10Z'
              }
              fill={'currentColor'}
            />
          </g>
          <defs>
            <clipPath id={'clip0_5661_1880'}>

...
const EditOutlinedIcon = (allProps: IconProps) => {
      ...
      icon={
        ...
        >
          <g clipPath={'url(#clip0_5661_1780)'}>
            ...
            <path
              d={
                'M5.00001 18H5.09001L9.26001 17.62C9.7168 17.5745 10.144 17.3732 10.47 17.05L19.47 8.05C19.8193 7.68097 20.0081 7.18851 19.995 6.68054C19.9819 6.17256 19.7679 5.69051 19.4 5.34L16.66 2.6C16.3024 2.2641 15.8338 2.07136 15.3433 2.05845C14.8529 2.04555 14.3748 2.21337 14 2.53L5.00001 11.53C4.67677 11.856 4.47551 12.2832 4.43001 12.74L4.00001 16.91C3.98654 17.0565 4.00554 17.2041 4.05567 17.3424C4.10579 17.4807 4.18581 17.6062 4.29001 17.71C4.38345 17.8027 4.49426 17.876 4.6161 17.9258C4.73794 17.9755 4.8684 18.0008 5.00001 18ZM15.27 4L18 6.73L16 8.68L13.32 6L15.27 4ZM6.37001 12.91L12 7.32L14.7 10.02L9.10001 15.62L6.10001 15.9L6.37001 12.91Z'
              }
              fill={'currentColor'}
            />
          </g>
